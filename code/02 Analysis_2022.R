...
#import data
data_full <- read.csv("Data/02 Intermediary_data/CO2DriversEU_dataset_2022_level1.csv")
...
#run loop over all variables to produce results for all IPCC categories
for(IPCC_code in 1:5){
  
  #set IPCC code and category
  emissions_code <- emissions_codes[IPCC_code,]
  emissions_category <- emissions_codes[IPCC_code,]
  
  #set up document
  file_name <- paste0("Data/03 Output_data/2022_level_1/",emissions_category)
  
  #filter data
  data <- data_full %>% 
    filter(category_name == emissions_code) %>% 
...
#import data
data_full <- read.csv("Data/02 Intermediary_data/CO2DriversEU_dataset_2022_level2.csv")
...
for(IPCC_code in 1:9){
  ...
  #set up document
  file_name <- paste0("Data/03 Output_data/2022_level_2/",emissions_category)
